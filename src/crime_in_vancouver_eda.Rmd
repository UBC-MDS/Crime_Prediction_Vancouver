...
Below table summarize the total number of each reported crime type
...
The project would also explore the density of reported crime for each neighbourhoods
