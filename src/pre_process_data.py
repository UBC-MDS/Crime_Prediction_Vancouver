...
'''This script cleans, splits and creates pre-processor for the Crime Vancouver data (from https://geodash.vpd.ca/opendata/)

Usage: pre_process_data.py --input_path=<input_path> --out_path=<out_path>
