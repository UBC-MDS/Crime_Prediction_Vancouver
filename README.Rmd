...
To replicate the analysis and run the predictor, first fork the repository to your personal repo and clone to your local environment. Then create and activate the conda environment as follows:
...
- A dependency diagram of the Makefile can be found [here](Makefile.png).
