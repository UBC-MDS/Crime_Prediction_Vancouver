...
```{r Heatmap, echo=FALSE, fig.height = 10, fig.width = 10, out.width = "200%"}
...
```{r Hour Pre-Rebalancing, echo=FALSE, fig.height = 3, fig.width = 5, out.width = "70%"}
...
```{r Hour Rebalancing, echo=FALSE, fig.height = 3, fig.width = 5, out.width = "70%"}
...
```{r Model results, echo=FALSE, fig.height = 10, fig.width = 10,, out.width = "200%"}
...
```{r Confusion Mqtrix, echo=FALSE, fig.height = 5, fig.width = 5, out.width = "200%"}
...
```{r classification report, echo=FALSE, fig.height = 15, fig.width = 10, out.width = "300%"}
