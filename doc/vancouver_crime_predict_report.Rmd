...
```{r Hour Pre-Rebalancing, echo=FALSE, fig.height = 3, fig.width = 5, fig.cap = "Fig 3.Comparasion of Data Before and After Rebalancing", out.width = "70%"}
...
```{r Confusion Mqtrix, echo=FALSE, fig.height = 5, fig.width = 5, fig.cap = "Fig 6. Confusion Matrix of LogisticRegressor performance on test data", out.width = "200%"}
