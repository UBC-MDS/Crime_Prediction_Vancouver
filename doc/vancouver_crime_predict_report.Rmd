...
include_graphics('../src/figure-gfm/crime_correlation.png')
...
include_graphics('../src/figure-gfm/crime_top5.png')
...
```{r Pipelie, echo=FALSE, fig.height = 10, fig.width = 10, fig.cap = "Fig 4. Model Results", out.width = "200%"}

include_graphics('../results/model_results.g')
...
For LogisticRegression, hyperparameters C and class_weight were optimized via RandomizedSearchCV to maximize f-1. The best model performed using C = 0.01 and class_weight = None. 
