...
```{r Heatmap, echo=FALSE, fig.height = 10, fig.width = 10, fig.cap = "Fig 2. Top 5 Neighborhoods with Crime", out.width = "200%"}
...
```{r model results, echo=FALSE, fig.height = 10, fig.width = 10, fig.cap = "Fig 3. Model Results", out.width = "200%"}
